...
export class CreatePostEntity1702054672896 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "posts" ADD CONSTRAINT "FK_43ae5b59527654c45cc0355324c" FOREIGN KEY ("createdBy") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
